  ...
  return (
    <div className="relative min-h-screen w-full sm:max-w-md mx-auto flex items-center justify-center overflow-hidden">
      ...
      <main className="relative w-full max-w-wd text-center p-6 space-y-10 z-40">
        ...
        {/*  Teks pembuka */}
        <p className={`${greatVibes.className} text-5xl italic text-gray-800 font-bold`}>
          The Wedding Of
        </p>

        {/* Nama pengantin */}
        <h1 className={`${greatVibes.className} text-6xl font-bold text-amber-800`}>Ary & Resi</h1>
